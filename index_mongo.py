...
# SPECIFICATION: A program to generate a command line GUI for user input in order to create, update & delete documents and gather an index of terms across all documents.
